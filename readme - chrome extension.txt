Save time on HN by marking stories and comments as read. Now with optional Chrome profile sync across devices.
...
Note: this is a maintained fork of the original extension by Dan Mazzini (danmaz74), updated to restore compatibility with the current Hacker News layout and modern Chrome extension standards. Full credit for the original concept and implementation belongs to the original author [1][2].
